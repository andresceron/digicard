...
passport_1.default.use('register', new LocalStrategy({
    ...
    try {
        ...
        logger_1.default.error('LocalStrategyRegisterError: ', e);
        done(e);
    }
}));
passport_1.default.use('jwt', new JWTStrategy(opts, function (jwt_payload, done) { return __awaiter(void 0, void 0, void 0, function () {
    var user, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_model_1.default.findOne({ _id: jwt_payload.id })];
            case 1:
                user = _a.sent();
                if (user) {
            ...
            case 2:
                e_1 = _a.sent();
                logger_1.default.error('jwtStrategyFindUserError: ', e_1);
