...
export class DataListComponent {
  ...
  @ContentChild('row', /* TODO: add static flag */ {}) rowTemplate: TemplateRef<NgTemplateOutlet>;
  @ContentChild('footer', /* TODO: add static flag */ {}) footerTemplate: TemplateRef<NgTemplateOutlet>;
